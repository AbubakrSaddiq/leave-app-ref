...
// Group permissions: Admin OR HR can access system settings
  ...
  return (
    <Tabs colorScheme="blue" variant="enclosed" isLazy>
      ...
      <TabPanels>
        {!canManageSystem && <TabPanel><BalanceDashboard /></TabPanel>}
        { !canManageSystem && <TabPanel><LeaveApplicationForm /></TabPanel>}
        {!canManageSystem && <TabPanel><MyLeaveApplications /></TabPanel>}
        ...
        {canManageSystem && <TabPanel><ReportsPage /></TabPanel>}
